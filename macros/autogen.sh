...
do 
  ...
  if test -f $dr/NO-AUTO-GEN; then
	...
	echo "Making $dr/aclocal.m4 writable ..."
	test -r $dr/aclocal.m4 && chmod u+w $dr/aclocal.m4
	echo "Fixing gettext's intl/Makefile.in ... Ignore non-fatal messages."
	patch -uN intl/Makefile.in < ./libintl-Makefile-in.diff
	test -f intl/Makefile.in.rej && rm -f intl/Makefile.in.rej
      fi
